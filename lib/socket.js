...
Socket.prototype.__proto__ = Stream.prototype;
...
/**
 * Accessor properties for the Stream interface.
 *
 * @api public
 */
...
Object.defineProperty(Socket.prototype, 'writable', {
  get: function () {
    return 'closed' !== this.readyState && this.transport.writable;
  }
});
...
/**
 * Write a message, this API is used for Stream compatiblity.
 *
 * @param {String} data
...
Socket.prototype.write = function (data) {
  return this.sendPacket('message', data + '');
};
 ...
 * @returns {Boolean} successful send
 * @api private
 */
