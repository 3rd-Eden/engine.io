...
Socket.prototype.onOpen = function () {
  ...
  this.server.onOpen(this, function (err, data) {
    ...
    data = data || {};
    data.sid = self.id;
    data.upgrades = self.getAvailableUpgrades();
    data.pingInterval = self.server.pingInterval;
    data.pingTimeout = self.server.pingTimeout;

    // sends an `open` packet
    self.transport.sid = self.id;
    self.sendPacket('open', JSON.stringify(data));
